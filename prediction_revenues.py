...
df = pd.read_csv('/Users/alexdonezwell/Desktop/cs534-master/final_pj/Meta_cleaned_genres.csv')
df_img = pd.read_pickle('/Users/alexdonezwell/Desktop/cs534-master/final_pj/poster_features')
df_img.to_csv(r'/Users/alexdonezwell/Desktop/cs534-master/final_pj/poster_features.csv')
...
y = df.revenue
X = drop_cols(df,['revenue','imdb_id'])
...
print('RMSLE score for linear model is {}'.format(rms(y_val, y_pred)))
print('RMSLE score for Lasso model is {}'.format(rms(y_val, lasso_pred)))
print('RMSLE score for k-NN model is {}'.format(rms(y_val, knn_y_pred)))
print('RMSLE score for Random Forest model is {}'.format(rms(y_val, rf_y_pred)))
print('RMSLE score for Decision tree model is {}'.format(rms(y_val, DT_pred)))
